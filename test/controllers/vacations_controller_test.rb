...
class VacationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vacation" do
    assert_difference('Vacation.count') do
      post vacations_url, params: { vacation: { endDate: @vacation.endDate, name: @vacation.name, startDate: @vacation.startDate, user_id: @vacation.user_id } }, as: :json
    end
  ...
  test "should update vacation" do
    patch vacation_url(@vacation), params: { vacation: { endDate: @vacation.endDate, name: @vacation.name, startDate: @vacation.startDate, user_id: @vacation.user_id } }, as: :json
    assert_response 200
  end
